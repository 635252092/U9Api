...
namespace U9Api.CustSV
{
    ...
    public class ApproveMaterialInSVStub : ISVStubBase, IApproveMaterialInSV
    {
        #region IApproveMaterialInSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.ApproveMaterialInSV");                
                ApproveMaterialInSV objectRef = new ApproveMaterialInSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.ApproveMaterialInSV");
            }
        }
	#endregion
    }
