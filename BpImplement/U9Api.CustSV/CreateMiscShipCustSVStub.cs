...
namespace U9Api.CustSV
{
    ...
    public class CreateMiscShipCustSVStub : ISVStubBase, ICreateMiscShipCustSV
    {
        #region ICreateMiscShipCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateMiscShipCustSV");                
                CreateMiscShipCustSV objectRef = new CreateMiscShipCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateMiscShipCustSV");
            }
        }
	#endregion
    }
