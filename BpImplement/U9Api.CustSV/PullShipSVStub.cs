...
namespace U9Api.CustSV
{
    ...
    public class PullShipSVStub : ISVStubBase, IPullShipSV
    {
        #region IPullShipSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.PullShipSV");                
                PullShipSV objectRef = new PullShipSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.PullShipSV");
            }
        }
	#endregion
    }
