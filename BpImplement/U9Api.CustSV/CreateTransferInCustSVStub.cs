...
namespace U9Api.CustSV
{
    ...
    public class CreateTransferInCustSVStub : ISVStubBase, ICreateTransferInCustSV
    {
        #region ICreateTransferInCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateTransferInCustSV");                
                CreateTransferInCustSV objectRef = new CreateTransferInCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateTransferInCustSV");
            }
        }
	#endregion
    }
