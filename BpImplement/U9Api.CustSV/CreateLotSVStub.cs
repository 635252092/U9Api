...
namespace U9Api.CustSV
{
    ...
    public class CreateLotSVStub : ISVStubBase, ICreateLotSV
    {
        #region ICreateLotSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateLotSV");                
                CreateLotSV objectRef = new CreateLotSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateLotSV");
            }
        }
	#endregion
    }
