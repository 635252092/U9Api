...
namespace U9Api.CustSV
{
    ...
    public class DeleteCustSVStub : ISVStubBase, IDeleteCustSV
    {
        #region IDeleteCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.DeleteCustSV");                
                DeleteCustSV objectRef = new DeleteCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.DeleteCustSV");
            }
        }
	#endregion
    }
