...
namespace U9Api.CustSV
{
    ...
    public class SOPushSMSVStub : ISVStubBase, ISOPushSMSV
    {
        #region ISOPushSMSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.SOPushSMSV");                
                SOPushSMSV objectRef = new SOPushSMSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.SOPushSMSV");
            }
        }
	#endregion
    }
