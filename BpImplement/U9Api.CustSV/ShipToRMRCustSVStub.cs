...
namespace U9Api.CustSV
{
    ...
    public class ShipToRMRCustSVStub : ISVStubBase, IShipToRMRCustSV
    {
        #region IShipToRMRCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.ShipToRMRCustSV");                
                ShipToRMRCustSV objectRef = new ShipToRMRCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.ShipToRMRCustSV");
            }
        }
	#endregion
    }
