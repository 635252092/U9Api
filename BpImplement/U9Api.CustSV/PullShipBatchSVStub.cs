...
namespace U9Api.CustSV
{
    ...
    public class PullShipBatchSVStub : ISVStubBase, IPullShipBatchSV
    {
        #region IPullShipBatchSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.PullShipBatchSV");                
                PullShipBatchSV objectRef = new PullShipBatchSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.PullShipBatchSV");
            }
        }
	#endregion
    }
