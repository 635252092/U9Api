...
namespace U9Api.CustSV
{
    ...
    public class RcvRptDocApproveSVStub : ISVStubBase, IRcvRptDocApproveSV
    {
        #region IRcvRptDocApproveSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.RcvRptDocApproveSV");                
                RcvRptDocApproveSV objectRef = new RcvRptDocApproveSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.RcvRptDocApproveSV");
            }
        }
	#endregion
    }
