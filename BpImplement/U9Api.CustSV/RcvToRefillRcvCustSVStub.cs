...
namespace U9Api.CustSV
{
    ...
    public class RcvToRefillRcvCustSVStub : ISVStubBase, IRcvToRefillRcvCustSV
    {
        #region IRcvToRefillRcvCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.RcvToRefillRcvCustSV");                
                RcvToRefillRcvCustSV objectRef = new RcvToRefillRcvCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.RcvToRefillRcvCustSV");
            }
        }
	#endregion
    }
