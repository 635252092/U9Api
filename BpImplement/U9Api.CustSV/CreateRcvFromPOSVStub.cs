...
namespace U9Api.CustSV
{
    ...
    public class CreateRcvFromPOSVStub : ISVStubBase, ICreateRcvFromPOSV
    {
        #region ICreateRcvFromPOSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateRcvFromPOSV");                
                CreateRcvFromPOSV objectRef = new CreateRcvFromPOSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateRcvFromPOSV");
            }
        }
	#endregion
    }
