...
namespace U9Api.CustSV
{
    ...
    public class RcvApproveSVStub : ISVStubBase, IRcvApproveSV
    {
        #region IRcvApproveSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.RcvApproveSV");                
                RcvApproveSV objectRef = new RcvApproveSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.RcvApproveSV");
            }
        }
	#endregion
    }
