...
namespace U9Api.CustSV
{
    ...
    public class CreateRcvFromRtnSVStub : ISVStubBase, ICreateRcvFromRtnSV
    {
        #region ICreateRcvFromRtnSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateRcvFromRtnSV");                
                CreateRcvFromRtnSV objectRef = new CreateRcvFromRtnSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateRcvFromRtnSV");
            }
        }
	#endregion
    }
