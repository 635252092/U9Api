...
namespace U9Api.CustSV
{
    ...
    public class CreateRcvFromRMRSVStub : ISVStubBase, ICreateRcvFromRMRSV
    {
        #region ICreateRcvFromRMRSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateRcvFromRMRSV");                
                CreateRcvFromRMRSV objectRef = new CreateRcvFromRMRSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateRcvFromRMRSV");
            }
        }
	#endregion
    }
