...
namespace U9Api.CustSV
{
    ...
    public class PullShipBatchStub : ISVStubBase, IPullShipBatch
    {
        #region IPullShipBatch Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.PullShipBatch");                
                PullShipBatch objectRef = new PullShipBatch();
            ...
            {
				FinallyInvoke("U9Api.CustSV.PullShipBatch");
            }
        }
	#endregion
    }
