...
namespace U9Api.CustSV
{
    ...
    public class CreateMaterialInSVStub : ISVStubBase, ICreateMaterialInSV
    {
        #region ICreateMaterialInSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateMaterialInSV");                
                CreateMaterialInSV objectRef = new CreateMaterialInSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateMaterialInSV");
            }
        }
	#endregion
    }
