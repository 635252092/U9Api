...
namespace U9Api.CustSV
{
    ...
    public class CreateRcvRptDocCustSVStub : ISVStubBase, ICreateRcvRptDocCustSV
    {
        #region ICreateRcvRptDocCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateRcvRptDocCustSV");                
                CreateRcvRptDocCustSV objectRef = new CreateRcvRptDocCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateRcvRptDocCustSV");
            }
        }
	#endregion
    }
