...
namespace U9Api.CustSV
{
    ...
    public class RMAPullShipCustSVStub : ISVStubBase, IRMAPullShipCustSV
    {
        #region IRMAPullShipCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.RMAPullShipCustSV");                
                RMAPullShipCustSV objectRef = new RMAPullShipCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.RMAPullShipCustSV");
            }
        }
	#endregion
    }
