...
namespace U9Api.CustSV
{
    ...
    public class ToRMRSVStub : ISVStubBase, IToRMRSV
    {
        #region IToRMRSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.ToRMRSV");                
                ToRMRSV objectRef = new ToRMRSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.ToRMRSV");
            }
        }
	#endregion
    }
