...
namespace U9Api.CustSV
{
    ...
    public class ApproveMiscShipCustSVStub : ISVStubBase, IApproveMiscShipCustSV
    {
        #region IApproveMiscShipCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.ApproveMiscShipCustSV");                
                ApproveMiscShipCustSV objectRef = new ApproveMiscShipCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.ApproveMiscShipCustSV");
            }
        }
	#endregion
    }
