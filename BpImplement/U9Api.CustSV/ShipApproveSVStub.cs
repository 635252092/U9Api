...
namespace U9Api.CustSV
{
    ...
    public class ShipApproveSVStub : ISVStubBase, IShipApproveSV
    {
        #region IShipApproveSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.ShipApproveSV");                
                ShipApproveSV objectRef = new ShipApproveSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.ShipApproveSV");
            }
        }
	#endregion
    }
