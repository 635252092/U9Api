...
namespace U9Api.CustSV
{
    ...
    public class RMAPullRCVCustSVStub : ISVStubBase, IRMAPullRCVCustSV
    {
        #region IRMAPullRCVCustSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.RMAPullRCVCustSV");                
                RMAPullRCVCustSV objectRef = new RMAPullRCVCustSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.RMAPullRCVCustSV");
            }
        }
	#endregion
    }
