...
namespace U9Api.CustSV
{
    ...
    public class CreateMaterialInDocSVStub : ISVStubBase, ICreateMaterialInDocSV
    {
        #region ICreateMaterialInDocSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.CreateMaterialInDocSV");                
                CreateMaterialInDocSV objectRef = new CreateMaterialInDocSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.CreateMaterialInDocSV");
            }
        }
	#endregion
    }
