...
namespace U9Api.CustSV
{
    ...
    public class UpdateTransferOutSVStub : ISVStubBase, IUpdateTransferOutSV
    {
        #region IUpdateTransferOutSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.UpdateTransferOutSV");                
                UpdateTransferOutSV objectRef = new UpdateTransferOutSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.UpdateTransferOutSV");
            }
        }
	#endregion
    }
