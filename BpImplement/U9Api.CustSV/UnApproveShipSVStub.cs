...
namespace U9Api.CustSV
{
    ...
    public class UnApproveShipSVStub : ISVStubBase, IUnApproveShipSV
    {
        #region IUnApproveShipSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.UnApproveShipSV");                
                UnApproveShipSV objectRef = new UnApproveShipSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.UnApproveShipSV");
            }
        }
	#endregion
    }
