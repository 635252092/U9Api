...
namespace U9Api.CustSV
{
    ...
    public class UnApproveTransferOutSVStub : ISVStubBase, IUnApproveTransferOutSV
    {
        #region IUnApproveTransferOutSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.UnApproveTransferOutSV");                
                UnApproveTransferOutSV objectRef = new UnApproveTransferOutSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.UnApproveTransferOutSV");
            }
        }
	#endregion
    }
