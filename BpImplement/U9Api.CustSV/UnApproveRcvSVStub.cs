...
namespace U9Api.CustSV
{
    ...
    public class UnApproveRcvSVStub : ISVStubBase, IUnApproveRcvSV
    {
        #region IUnApproveRcvSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String jsonRequest)
        {
            ...
            try
            {
                BeforeInvoke("U9Api.CustSV.UnApproveRcvSV");                
                UnApproveRcvSV objectRef = new UnApproveRcvSV();
            ...
            {
				FinallyInvoke("U9Api.CustSV.UnApproveRcvSV");
            }
        }
	#endregion
    }
