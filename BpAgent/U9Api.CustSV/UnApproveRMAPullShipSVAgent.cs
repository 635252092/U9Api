...
namespace U9Api.CustSV.Proxy
{
	...
	[Serializable]    
    public class UnApproveRMAPullShipSVProxy : ServiceProxyBase//, U9Api.CustSV.Proxy.IUnApproveRMAPullShipSV
    {
	#region Fields	
	...
	#region Constructors
        public UnApproveRMAPullShipSVProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeBySite<U9Api.CustSV.Proxy.IUnApproveRMAPullShipSV>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeByOrg<U9Api.CustSV.Proxy.IUnApproveRMAPullShipSV>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<U9Api.CustSV.Proxy.IUnApproveRMAPullShipSV>();
			return GetRealResult(result);
        }
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IUnApproveRMAPullShipSV channel = oChannel as IUnApproveRMAPullShipSV;
            if (channel != null)
            {
