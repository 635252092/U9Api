...
namespace U9Api.CustSV.Proxy
{
	...
	[Serializable]    
    public class CreateRMRSVProxy : ServiceProxyBase//, U9Api.CustSV.Proxy.ICreateRMRSV
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeBySite<U9Api.CustSV.Proxy.ICreateRMRSV>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeByOrg<U9Api.CustSV.Proxy.ICreateRMRSV>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<U9Api.CustSV.Proxy.ICreateRMRSV>();
			return GetRealResult(result);
        }
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            ICreateRMRSV channel = oChannel as ICreateRMRSV;
            if (channel != null)
            {
